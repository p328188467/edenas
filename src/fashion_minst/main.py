...
from src.fashion_minst.data_utils import read_data
from src.fashion_minst.general_controller import GeneralController
from src.fashion_minst.general_child import GeneralChild

from src.fashion_minst.micro_controller import MicroController
from src.fashion_minst.micro_child import MicroChild
...
DEFINE_integer("child_filter_size", 4, "")
DEFINE_integer("child_out_filters", 24, "")
DEFINE_integer("child_out_filters_scale", 1, "")
DEFINE_integer("child_num_branches", 2, "")
DEFINE_integer("child_num_aggregate", None, "")
DEFINE_integer("child_num_replicas", 1, "")
DEFINE_integer("child_block_size", 2, "")
